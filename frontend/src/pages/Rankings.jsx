    ...
    <div style={{ position: 'relative', overflow: 'hidden' }}>
      ...
      <div className="section-padding container-width">
        ...
        <div style={{ textAlign: 'center', marginBottom: '48px' }}>
          <span style={{ color: '#2563eb', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.1em', fontSize: '0.9rem' }}>Standings</span>
        ...
        {loading ? (
          ...
          <div className="glass-panel" style={{ overflowX: 'auto', padding: '16px', borderRadius: '16px' }}>
            <table style={{
              width: '100%',
              ...
              <thead>
                <tr style={{ borderBottom: '1px solid rgba(255, 255, 255, 0.08)' }}>
                  <th style={{ padding: '16px', color: '#94a3b8', fontWeight: 600, fontSize: '0.85rem', textTransform: 'uppercase' }}>Rank</th>
                  <th style={{ padding: '16px', color: '#94a3b8', fontWeight: 600, fontSize: '0.85rem', textTransform: 'uppercase' }}>Player</th>
                  <th style={{ padding: '16px', color: '#94a3b8', fontWeight: 600, fontSize: '0.85rem', textTransform: 'uppercase' }}>Playing Style</th>
                  <th style={{ padding: '16px', color: '#94a3b8', fontWeight: 600, fontSize: '0.85rem', textTransform: 'uppercase' }}>Hand</th>
                  <th style={{ padding: '16px', color: '#94a3b8', fontWeight: 600, fontSize: '0.85rem', textTransform: 'uppercase' }}>Current Blade</th>
                  <th style={{ padding: '16px', color: '#94a3b8', fontWeight: 600, fontSize: '0.85rem', textTransform: 'uppercase', textAlign: 'right' }}>Profile</th>
                </tr>
              </thead>
              <tbody>
                <style>{`
                    ...
                    <tr key={player._id || player.id} className="ranking-row">
                      ...
                      <td style={{ padding: '16px' }}>
                        <span style={{
                          ...
                          border: `1px solid ${player.rank === 1 ? '#d4af37' : player.rank === 2 ? '#c0c0c0' : player.rank === 3 ? '#cd7f32' : 'rgba(255,255,255,0.08)'}`,
                          color: player.rank === 1 ? '#d4af37' : player.rank === 2 ? '#c0c0c0' : player.rank === 3 ? '#cd7f32' : '#ffffff',
                          fontWeight: 700,
                          fontSize: '0.9rem',
                      ...
                      <td style={{ padding: '16px' }}>
                        <Link to={`/player/${player._id || player.id}`} style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                          ...
                          <span style={{ fontWeight: 600, color: '#f8fafc', fontSize: '0.95rem' }}>{player.name}</span>
                        </Link>
                      </td>
          ...
          <div className="glass-panel" style={{ padding: '60px 24px', textAlign: 'center', color: '#64748b' }}>
            <FaTableTennis style={{ fontSize: '48px', color: '#1e293b', marginBottom: '12px' }} />
